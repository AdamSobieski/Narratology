...
* This project will explore stateful systems and their interoperations with large language models.
...
* This project will explore various approaches, e.g., pedagogical (black-box) and compositional (white-box), for extracting automata systems from ([ONNX](https://en.wikipedia.org/wiki/Open_Neural_Network_Exchange)) [recurrent neural networks](https://en.wikipedia.org/wiki/Recurrent_neural_network) using [ML.NET](https://github.com/dotnet/machinelearning) software libraries.
