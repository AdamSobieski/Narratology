...
* stateful systems and interoperations with large language models.
...
* pedagogical (black-box) and compositional (white-box) approaches for extracting automata-related systems from ([ONNX](https://en.wikipedia.org/wiki/Open_Neural_Network_Exchange)) [recurrent neural networks](https://en.wikipedia.org/wiki/Recurrent_neural_network) using [ML.NET](https://github.com/dotnet/machinelearning) software libraries.
