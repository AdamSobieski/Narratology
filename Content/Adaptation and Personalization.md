...
6. Might fine-grained control of adaptation and personalization, this potentially involving detailed hints, be a topic for HTML style? Content in `<q>` and `<blockquote>` elements, for instance, might have special default values.
