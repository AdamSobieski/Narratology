...
It will be convenient for developers to be able to simply create and work with intensional sets. Developers would also enjoy being able to create and work with ad-hoc "concepts".

Intensional sets resemble the [classical theory](https://en.wikipedia.org/wiki/Concept#Classical_theory) of concepts and [definitionism](https://en.wikipedia.org/wiki/Definitionism) and there are other theories of concepts to consider, e.g., the [prototype theory](https://en.wikipedia.org/wiki/Concept#Prototype_theory).
