...
<details>
<summary>Click to view four approaches for representing n-ary predicate-calculus expressions in RDF Turtle and TriG.</summary>
<br>
...
Thirdly, one could use constant values as subjects, e.g., `true` and `false`.
...
Fourthly, one could invert the subjects and objects from approach three, above.
