...
Upcoming, I will explore adding a method, e.g., `GetTraverser()`, to acceptors and transducers which will return objects implementing interfaces extending `IObserver<TInput>`, `IObservable<TOutput>`, and some other interfaces from the `System.Reactive` library.
