...
Declarative natural-language generation can occur on servers, capable of being precomputed and cached for coordinates, distributions, or regions in users' adaptation-parameter spaces, and/or on client devices.
