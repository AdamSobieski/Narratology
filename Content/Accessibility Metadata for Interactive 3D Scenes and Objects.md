...
For some media types, [WebVTT](https://www.w3.org/TR/webvtt1/) [metadata](https://www.w3.org/TR/webvtt1/#introduction-metadata) tracks could, using JSON or JSON-LD, stream RDF graphs and [diff or patch](https://www.w3.org/DesignIssues/Diff) content. These time-aligned metadata tracks might contain both ["intra-coded" and "predicted"](https://en.wikipedia.org/wiki/Video_compression_picture_types#Intra-coded_(I)_frames/slices_(key_frames)) messages.
