...
4. With respect to affordances and functionalities, perhaps those DOM elements or knowledge-graph nodes of 3D-graphics contents' semantic models could each have sets of MCP tools.
