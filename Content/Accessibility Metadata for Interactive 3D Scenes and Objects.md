...
With respect to question #2, one could add a property, `readonly`, with an enumerated value for indicating whether an object's metadata were readonly or writeable. A contextually toggleable `expanded` property, however, suggests that at least some metadata content for loaded 3D scenes or objects would be mutable or writeable.
